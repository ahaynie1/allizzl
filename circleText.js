(function ($) {
  function initTurnCss() {
    var css =
        "@-webkit-keyframes circTxt--rotating{from{transform-origin:center;-webkit-transform:rotate(0);-o-transform:rotate(0);transform:rotate(0)}to{transform-origin:center;-webkit-transform:rotate(360deg);-o-transform:rotate(360deg);transform:rotate(360deg)}}",
      ...
      var params = {
        ...
        duration:
          "duration" in parameters
            ? parameters.duration
            : paramsdefault.duration,
        repeat:
          "repeat" in parameters ? parameters.repeat : paramsdefault.repeat,
        radius:
          "radius" in parameters ? parameters.radius : paramsdefault.radius,
        background:
